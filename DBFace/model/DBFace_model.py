...
class CBNModule(nn.Module):
    def __init__(self, inchannel, outchannel=24, kernel_size=3, stride=1, padding=0, bias=False):
        ...
        self.conv = nn.Conv2d(inchannel, outchannel,
...
class DBFace(nn.Module):
    def __init__(self):
        ...
        self.conv3 = CBNModule(960, 320, kernel_size=1,
                               stride=1, padding=0, bias=False)  # 32
        self.conv4 = CBNModule(320, 24, kernel_size=1,
                               stride=1, padding=0, bias=False)  # 32
